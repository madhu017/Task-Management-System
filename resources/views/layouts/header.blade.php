            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu"><li><i class="fa fa-puzzle-piece"></i><a href="{{ route('createtask')}}">Add new task</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="/editalltask">Edit tasks</a></li>  
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/completedtask">Completed Tasks</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ route('inprogress')}}">In Progress Tasks</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
